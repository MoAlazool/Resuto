...
process.env.NETLIFY_BLOBS_CONTEXT=Buffer.from(JSON.stringify({siteID:'verify-site',token:'verify-token',edgeURL:'https://blobs.invalid',uncachedEdgeURL:'https://blobs.invalid'})).toString('base64');
