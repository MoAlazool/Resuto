...
const tableKeys=['id','label','capacity','zone','shape','cx','cy','width','height','rotation','features','reservable','branchId','minimumSpend','premium','locked'];
